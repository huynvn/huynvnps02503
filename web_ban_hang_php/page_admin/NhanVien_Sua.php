...
$truyvan_layDuLieu=mysql_query($layDuLieu);
if(mysql_num_rows($truyvan_layDuLieu)>0)
{
    $cot=mysql_fetch_array($truyvan_layDuLieu);
}
else
{
    echo "<script>location='NhanVien.php';</script>";
...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $truyvan_ktTonTai=mysql_query($ktTonTai);
    if(mysql_num_rows($truyvan_ktTonTai)>0)
    {
