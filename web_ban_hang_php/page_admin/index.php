...
$tongSP=mysql_num_rows(mysql_query("SELECT * FROM sanpham"));
$tongLSP=mysql_num_rows(mysql_query("SELECT * FROM loaisp"));
$tongTV=mysql_num_rows(mysql_query("SELECT * FROM thanhvien"));
$tongNV=mysql_num_rows(mysql_query("SELECT * FROM nhanvien"));
$tongBL=mysql_num_rows(mysql_query("SELECT * FROM binhluan"));
$tongDDH=mysql_num_rows(mysql_query("SELECT * FROM dondat"));
$ddhChua=mysql_num_rows(mysql_query("SELECT * FROM dondat WHERE TrangThai=0"));
$ddhDa=mysql_num_rows(mysql_query("SELECT * FROM dondat WHERE TrangThai=1"));
