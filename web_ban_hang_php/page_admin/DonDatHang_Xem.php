...
if(mysql_num_rows($truyvan_layDonDat)>0)
{
    //lay thong tin don dat hang
    $cotDDH=mysql_fetch_array($truyvan_layDonDat);
    ...
    $layCT_DonDat="SELECT  sanpham.*, ct_dondat.* FROM ct_dondat
                ...
                WHERE MaDonDat='".$_GET["MaDonDat"]."'";
    $truyvan_layCT_DonDat=mysql_query($layCT_DonDat);
                    ...
                    <div >
                        <form id="frmDuyetDDH" method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                            <table class="table table-bordered">
                                ...
                                <?php
                                $tongtien=0;
                                while($cotCT_DDH=mysql_fetch_array($truyvan_layCT_DonDat))
                                    {
...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $truyvan_layNV=mysql_query($layNV);
    $cotTV=mysql_fetch_array($truyvan_layNV);
