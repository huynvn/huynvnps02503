...
if(isset($_SESSION["tendangnhap"])) {
    ...
    $truyvanlayDG_ND=mysql_query($layDG_ND);

    if(mysql_num_rows($truyvanlayDG_ND)>0) {
        $cotDG=mysql_fetch_array($truyvanlayDG_ND);
        $sosao = $cotDG["NoiDung"];
    }
}
...
$truyvan_layBinhLuan=mysql_query($layBinhLuan);
    ...
    <div class="container">
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="details-left-info simpleCart_shelfItem">
                            ...
                            ( <?php echo mysql_num_rows($truyvan_layDG) ?> đánh giá )
                ...
                <?php while($cotBL=mysql_fetch_array($truyvan_layBinhLuan)) {?>
                ...
                <div class="latest products">
                    <div class="product-one">
                        ...
                        <div class="col-md-12 p-left">
                            ...
                            <?php
                            $i=0;
                            while($cot=mysql_fetch_array($truyvan_laySanPhamLQ))
                            {
                                $i++;
                                ?>
                                <div class="product-one">
            ...
            <div class="col-md-3 p-right single-right">
                ...
                <ul class="product-categories">
                    ...
                    while($cot=mysql_fetch_array($truyvan_layLoaiSP))
                    {
                        ?>
